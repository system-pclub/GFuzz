./bin/inst -file examples/inst/chrec/before.go -out examples/inst/chrec/after.go -pass chrec
./bin/inst -file examples/inst/cvrec/before.go -out examples/inst/cvrec/after.go -pass cvrec
